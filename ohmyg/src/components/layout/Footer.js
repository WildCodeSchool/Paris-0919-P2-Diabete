                ...
                <a href="#">
                    <div className="contactUs">
                        <svg  width="40px" height="40px" viewBox="0 0 114 114"  >
                            <path d="M112.6,41.3l-9.7-6.4V14.4c0-1.8-1.5-3.3-3.3-3.3H72.8L59,0.6c-1.2-0.9-2.8-0.9-4,0L41.3,11.1H14.4c-1.8,0-3.3,1.5-3.3,3.3
                ...
                <a href="#">
                    <div className="terms">
                        <svg   width="40px" height="40px" viewBox="0 0 122.2 115.5" >
                            <path d="M104.6,0H32.2c-9.7,0-17.6,7.8-17.6,17.3v63.8c-4.3,0.7-8,2.9-10.7,6.3c-2.9,3.6-4.2,8.1-3.7,12.6c1,8.8,8.5,15.4,17.5,15.4
