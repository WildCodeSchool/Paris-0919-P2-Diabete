            ...
            <div className = "Navbar_logo">
                ...
                <ul className="Navbar_ul" >
                    <li className="Navbar_li">
                        <NavLink exact to="/" class="Navbar_iconHome"  target="_blank">
                    ...
                    <li className="Navbar_li">
                        <NavLink exact to="/calculation" className="icones" href="https://www.instagram.com/" target="_blank">
                            <svg version="1.0" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50px"
                height="40px" viewBox="0 0 205.7 150.7" enable-background="new 0 0 205.7 150.7">
                                <defs>
                                </defs>
                                <path d="M103.6,20.3c-34.2,0-62,27.8-62,62c0,34.2,27.8,62,62,62c34.2,0,62-27.8,62-62C165.6,48.1,137.8,20.3,103.6,20.3z
                                ...
                                z"/>
                                <path d="M33.2,1.5v32.3h-4.4V1.5h-6.7v32.3h-4.4V1.5h-6.7l0,32.3H6.7L6.8,1.5H0.2L0,34.1v6.3c0,3.8,1.5,7.5,4.2,10.2l4,4l-4.7,79.9
                                ...
                                <path d="M141,64.1L141,64.1l-5.7,4.4l0,0c1.9,4.4,2.9,9.1,2.9,13.7c0,19.1-15.5,34.6-34.6,34.6S69,101.4,69,82.3
                                ...
                                <path d="M199,86.1l3.5-4.3c2.3-2.9,3.4-6.6,3.2-10.4l-0.5-6.3l-0.1-0.6l0,0l-6.4-39.9c0-0.2-0.2-3.8-2-12.6
                ...
                {/* <li className="Navbar_li">
                <NavLink className="icones" href="https://www.instagram.com/" target="_blank">
                <svg version="1.0" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40px"
                height="40px" viewBox="0 0 117.3 149.7" enable-background="new 0 0 117.3 149.7" >
                <defs>
                </defs>
                <g>
                <path  d="M110,0H7.3C3.3,0,0,3.3,0,7.3v135.2c0,4,3.3,7.3,7.3,7.3H110c4,0,7.3-3.3,7.3-7.3V7.3C117.3,3.3,114,0,110,0z
                ...
                <li className="Navbar_li">
                <NavLink class="icones" href="https://www.instagram.com/" target="_blank">
    <svg version="1.0" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40px"
	height="40px" viewBox="0 0 129.6 148.7" enable-background="new 0 0 129.6 148.7" >
<defs>
</defs>
<g>
	<path d="M53.2,72.9c16,0,29.1-13,29.1-29.1s-13-29.1-29.1-29.1s-29.1,13-29.1,29.1S37.2,72.9,53.2,72.9z M55.6,32.8l4.1,3.2
	...
	<path d="M110.5,47.6l0-47.6H0v136.3c0,6.8,5.5,12.4,12.4,12.4h104.9c6.8,0,12.4-5.5,12.4-12.4V47.7L110.5,47.6z M106.9,143H12.4
...
<g>
	<path d="M96.3,56.5c-11.1-7.8-24.7-9.6-38.4-5.1c-14-4.9-27.6-3.5-38.5,4C7.3,63.9,0,79.1,0,96c0,31.3,26,56.8,57.9,56.8
	...
	<path d="M55.3,42.7l3.5,0c0.8,0,20.9-0.3,33.6-10.8c13-10.8,12.9-27.7,12.9-28.4L105.2,0l-3.5,0c-0.8,0-20.9,0.3-33.6,10.8
	...
	<path d="M58.2,81.4c1.5,0,2.7-0.5,3.6-1.4c1-0.9,1.4-2.1,1.4-3.5c0-1.4-0.5-2.6-1.4-3.5c-0.9-0.9-2.2-1.4-3.6-1.4
