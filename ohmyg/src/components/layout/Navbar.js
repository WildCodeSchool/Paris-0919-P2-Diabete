...
const Navbar = props => (
    ...
    <div className = "Navbar_logo"><a href="/">LOGO</a></div>
        <nav className = "Navbar_Navigation">
                <a className="">
                    <svg id = "icon-nav" width="50" height="50" viewBox="0 0 90 90">
                    ...
                    c-6.6,0-12-5.4-12-12s5.4-12,12-12s12,5.4,12,12S52.3,57.9,45.7,57.9L45.7,57.9z M69.2,26.7c0,2.4-1.9,4.3-4.3,4.3                        c-2.4,0-4.3-1.9-4.3-4.3s1.9-4.3,4.3-4.3l0,0C67.3,22.4,69.2,24.4,69.2,26.7z" />
                    </svg>
                </a>
                <a>
                    <svg id = "icon-nav" width="50" height="50" viewBox="0 0 90 90">
